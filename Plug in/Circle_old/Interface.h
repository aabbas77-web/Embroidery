...
//---------------------------------------------------------------------------
extern "C" __declspec(dllexport) void Initialize(TFunc_Redraw f_Redraw,TFunc_DrawLine func_DrawLine,
...
extern "C" __declspec(dllexport) int Draw(int Msg,int Step,double x,double y,bool OnlyOne);
//---------------------------------------------------------------------------
#endif
