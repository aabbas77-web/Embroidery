...
uses
  ...
  Consts, Registry, ExtCtrls, StdCtrls, DsgnIntf, ExtDlgs, Clipbrd,
  ImgList, ComCtrls, Menus, ToolWin, G32, G32_Image, G32_Filters;
...
type
  TPictureEditorForm = class(TForm)
    ...
    procedure AlphaChannelMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
    procedure RGBChannelsMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
  protected
