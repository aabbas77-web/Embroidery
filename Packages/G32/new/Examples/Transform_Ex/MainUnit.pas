...
uses
  ...
  G32, G32_Image, G32_Transforms, G32_Layers, ExtCtrls, StdCtrls, Buttons,
  ComCtrls, Grids, G32_RangeBars;
...
begin
  ...
  SetBorderTransparent(Src.Bitmap,
    Rect32(0, 0, Src.Bitmap.Width - 1, Src.Bitmap.Height - 1));
end;
