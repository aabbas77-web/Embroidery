...
begin
  ...
  if BackgndImage.Empty then PaintBuffer.Clear(Color32(Color))
    ...
    BackgndImage.DrawTo(PaintBuffer,
      Rect32(Edge, Edge, Width - Edge, Height - Edge));
    ...
    begin
      ...
      if NodePoints <> nil then
        ...
        begin
          ...
          R := Rect32(x - NodeSize, y - NodeSize, x + NodeSize, y + NodeSize);
          IntersecTRect(R, R, Rect32(0, 0, Width - 1, Height - 1));
...
begin
  ...
  begin
    ...
    if NodePoints[n].X < 255 then
      Interpolate(NodePoints[n], Point32(255, DefaultRightEdge));
  end;
  Invalidate;
end;
