...
type
  TMainForm = class(TForm)
    ...
    procedure ImgViewPaintStage(Sender: TObject; StageNum: Cardinal);
    ...
    procedure ImgViewMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
...
procedure TMainForm.ImgViewPaintStage(Sender: TObject; StageNum: Cardinal);
var
  I, J: Integer;
  P: PColor32;
  OddY: Boolean;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if Odd(I shr 3) = OddY then P^ := $FFFFFFFF
        else P^ := $FFB0B0B0;
        Inc(P);
      end;
    end;
...
begin
  ...
  begin
    ...
    begin
      ...
      RBLayer.LayerOptions := 0; // disable both LOB_GDI_OVERLAY and LOB_MOUSE_EVENTS
    ...
    begin
      ...
      RBLayer.LayerOptions := LOB_GDI_OVERLAY or LOB_MOUSE_EVENTS;
...
procedure TMainForm.RBMouseDown(Sender: TObject; Buttons: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
