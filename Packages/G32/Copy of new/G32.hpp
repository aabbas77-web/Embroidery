...
extern PACKAGE Windows::TPoint __fastcall Point(int X, int Y)/* overload */;
extern PACKAGE Windows::TPoint __fastcall Point(const TFloatPoint &FP)/* overload */;
extern PACKAGE Windows::TPoint __fastcall Point(const TFixedPoint &FXP)/* overload */;
...
extern PACKAGE Windows::TRect __fastcall Rect(int L, int T, int R, int B)/* overload */;
extern PACKAGE Windows::TRect __fastcall Rect(const TFloatRect &FR, TRectRounding Rounding)/* overload */
	;
extern PACKAGE Windows::TRect __fastcall Rect(const TFixedRect &FXR, TRectRounding Rounding)/* overload */
	;
