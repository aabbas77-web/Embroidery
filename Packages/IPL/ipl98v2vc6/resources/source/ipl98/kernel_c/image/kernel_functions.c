...
bool k_AllocImage(UINT32 Width, UINT32 Height, UINT16 Bits,TImage* pInfo)
{
	...
	else
	{
		...
		k_ShowMessage(IPL_ERROR,&str,"k_AllocImage() Bits=%d not supported",Bits);
		k_EmptyString(&str);
		return false;
	}
}
...
bool k_AllocImageFast(UINT32 Width, UINT32 Height, UINT16 Bits,TImage* pInfo)
{
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_AllocImageFast() Bits=%d not supported",Bits);
		k_EmptyString(&str);
		return false;
	}
}
...
bool k_FlushImage(UINT32 Color,TImage* pDest)
{
	if (pDest==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_FlushImage() pDest is a NULL pointer");
		k_EmptyString(&str);
		return false;
	}
	else if (pDest->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_FlushImage() Image is empty - doing nothing");
		k_EmptyString(&str);
		return false;
	}
	else if ((pDest->Bits!=1) && (pDest->Bits!=8) && (pDest->Bits!=24))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_FlushImage() %d b/p not supported - doing nothing",
			pDest->Bits);
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			...
			k_SprintfString(&History,"%sk_FlushImage(Color=%d)",ipl_HistoryIndent,Color);
		...
		if (pDest->Bits==1)
		{
			if (Color>1)
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_FlushImage() Color=%d not valid for an image with 1 b/p",Color);
				k_EmptyString(&str);
				return false;
			}
			if (Color==0)
		...
		else if (pDest->Bits==8)
		{
			if (Color>255)
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_FlushImage() Color=%d not valid for an image with 8 b/p",Color);
				k_EmptyString(&str);
				return false;
			}
...
bool k_InvertImage(TImage* pInfo)
{
	...
	if (pInfo==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_InvertImage() pDest is a NULL pointer");
		k_EmptyString(&str);
		return false;
	}
	else if (pInfo->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_InvertImage() Image is empty - doing nothing");
		k_EmptyString(&str);
		return false;
	}
#ifdef IPL_ADD_HISTORY
	/* add comment to history */
	{
		TString History;
		k_InitString(&History);
		k_SprintfString(&History,"%sk_InvertImage()",ipl_HistoryIndent);
		k_AppendTextIPL(&(pInfo->History),History.pChars);
		k_EmptyString(&History);
		k_IplStartHistoryMacro();
	}
#endif
...
bool k_Load(const char* PathAndFileName, TImage* pInfo)
{
	...
	if (!k_SplitFileName(PathAndFileName, &Path,&FileNameExt,&Ext))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Load() Filename not valid");
		k_EmptyString(&str);
		return false;
	}
	else if (strcmp(Ext,"")==0)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Load() No extension found");
		k_EmptyString(&str);
		returnValue=false;
	}
	else
	{
		...
		if (fp==NULL)
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_Load() Failed opening file %s",PathAndFileName);
			k_EmptyString(&str);
			returnValue=false;
		}
		...
		else
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_Load() No valid extension found");
			k_EmptyString(&str);
			returnValue=false;
		}
		if (returnValue==true)
		{
			...
			/* add comment to history */
			{
				TString History;
				k_InitString(&History);
				k_SprintfString(&History,"%sk_Load(%s)",ipl_HistoryIndent,PathAndFileName);
				k_AppendTextIPL(&(pInfo->History),History.pChars);
				k_EmptyString(&History);
			}
#endif
...
bool k_Save(const char* FileName, TImage* pInfo)
{
	...
	if (!k_SplitFileName(FileName, &Path,&FileNameExt,&Ext))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Save() Filename not valid");
		k_EmptyString(&str);
		return false;
	}
	else if (strcmp(Ext,"")==0)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Save() No extension found");
		k_EmptyString(&str);
		returnValue=false;
	}
	else
	{
		...
		if (fp==NULL)
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_Save() Could not save file");
			k_EmptyString(&str);
			returnValue=false;
		}
		else if (pInfo->Origin==EMPTY)
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_Save() No image - cannot save");
			k_EmptyString(&str);
			returnValue=false;
		}
		...
		else
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_Save() Unknown file type");
			k_EmptyString(&str);
			returnValue=false;
		}
		if (returnValue==true)
		{
			...
			/* add comment to history */
			{
				TString History;
				k_InitString(&History);
				k_SprintfString(&History,"%sk_Save(%s)",ipl_HistoryIndent,FileName);
				k_AppendTextIPL(&(pInfo->History),History.pChars);
				k_EmptyString(&History);
			}
#endif
...
UINT8 k_GetRedComponent(int x, int y, const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_GetRedComponent() Only implemented for 1,8 and 24 bit per pixels");
				k_EmptyString(&str);
				return 0;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetRedComponent(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return 0;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_GetRedComponentFast() Only implemented for 1,8 and 24 bit per pixels");
			k_EmptyString(&str);
			return 0;
		}
	}
...
UINT8 k_GetGreenComponent(int x, int y, const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_GetGreenComponent() Only implemented for 1,8 and 24 bit per pixels");
				k_EmptyString(&str);
				return 0;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetGreenComponent(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return 0;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_GetGreenComponentFast() Only implemented for 1,8 and 24 bit per pixels");
			k_EmptyString(&str);
			return 0;
		}
	}
...
UINT8 k_GetBlueComponent(int x, int y, const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_GetBlueComponent() Only implemented for 1,8 and 24 bit per pixels");
				k_EmptyString(&str);
				return 0;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetBlueComponent(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return 0;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_GetBlueComponentFast() Only implemented for 1,8 and 24 bit per pixels");
			k_EmptyString(&str);
			return 0;
		}
	}
...
bool k_SetRedComponent(int x, int y, UINT8 RedValue, const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetRedComponent() Only possible for 24 bis per pixel");
				k_EmptyString(&str);
				return false;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SetRedComponent(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return false;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_SetRedComponentFast() Only possible for 24 bis per pixel");
			k_EmptyString(&str);
			return false;
		}
	}
...
bool k_SetGreenComponent(int x, int y, UINT8 GreenValue, const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetGreenComponent() Only possible for 24 bis per pixel");
				k_EmptyString(&str);
				return false;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SetGreenComponent(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return false;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_SetGreenComponentFast() Only possible for 24 bis per pixel");
			k_EmptyString(&str);
			return false;
		}
	}
...
bool k_SetBlueComponent(int x, int y, UINT8 BlueValue, const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetBlueComponent() Only possible for 24 bis per pixel");
				k_EmptyString(&str);
				return false;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SetBlueComponent(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return false;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_SetBlueComponentFast() Only possible for 24 bis per pixel");
			k_EmptyString(&str);
			return false;
		}
	}
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetBorder() Only possible for 1, 8 or 24 bit per pixel");
				k_EmptyString(&str);
				return false;
			}
	}
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetBorderSize() Only possible for 1, 8 or 24 bit per pixel");
				k_EmptyString(&str);
				return false;
			}
	}
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetBorderColor() Only possible for 1, 8 or 24 bit per pixel");
				k_EmptyString(&str);
...
bool k_SetPeriodicBorder(unsigned short BorderSize,TImage* pInfo)
{
	if (pInfo->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SetPeriodicBorder() Image is empty");
		k_EmptyString(&str);
		return false;
	}
	else if (((unsigned int)BorderSize>pInfo->Width) || ((unsigned int)BorderSize>pInfo->Height))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SetPeriodicBorder() Border too large");
		k_EmptyString(&str);
		return false;
	}
	else
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetPeriodicBorder() Only possible for 1, 8 or 24 bit per pixel");
				k_EmptyString(&str);
				return false;
			}
		}
...
bool k_CopyImage(TImage* pDest,const TImage* pSource)
{
	if (pDest==pSource)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopyImage() Source and destination image"
	...
	if (pSource->Origin!=EMPTY)
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyImage() Source image file info: %s"
				  ...
				  TImage* pDest,const TImage* pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_CopySubImage() Source image is empty - doing nothing");
		k_EmptyString(&str);
		return false;
	}
	else if ((pSource->Bits!=1) && (pSource->Bits!=8) && (pSource->Bits!=24))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_CopySubImage() %d b/p not supported - doing nothing",pSource->Bits);
		k_EmptyString(&str);
		return false;
	}
		...
		(xmax<=k_GetMaxX(pSource)) && (ymax<=k_GetMaxY(pSource)))
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopySubImage(xmin=%d,ymin=%d,xmax=%d,ymax=%d) Source image file info: %s"
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopySubImage() Illegal clipping rectangel");
		k_EmptyString(&str);
		return false;
	}
}
...
bool k_CopyConvert(UINT16 DestBits, TImage* pDest, const TImage* pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_CopyConvert() Source image is empty - doing nothing");
		k_EmptyString(&str);
		return false;
	}
	if ((DestBits!=1) && (DestBits!=8) && (DestBits!=24))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopyConvert() Destination with %d bits per pixel not supported",
			DestBits);
		k_EmptyString(&str);
		return false;
	}
	...
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyConvert() From %d b/p to %d b/p, source image file info: %s",
				ipl_HistoryIndent,pSource->Bits,DestBits,pSource->FileInfo.PathAndFileName);
			k_AppendTextIPL(&(pTarget->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
		...
		else
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_CopyConvert() The combination: %d b/p to %d b/p not implemented!",
...
bool k_CopyConvertThreshold(TImage* pDest, UINT8 Threshold, const TImage* pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_CopyConvertThreshold() Source image is empty - doing nothing");
		k_EmptyString(&str);
		return false;
	}
	/* Do the copying */
	...
	if (pSource->Bits!=8)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_CopyConvertThreshold() Source image must have 1 b/p (current has %d b/p)",
			pSource->Bits);
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyConvertThreshold() From 8 b/p to 1 b/p (always), source image file info: %s",
				ipl_HistoryIndent,pSource->FileInfo.PathAndFileName);
			k_AppendTextIPL(&(pTarget->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
...
void k_Rotate90(int Steps,TImage* pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_Rotate90() Image is empty - doing nothing");
		k_EmptyString(&str);
		return;
	}
	if ((pSource->Bits!=1) && (pSource->Bits!=8) && (pSource->Bits!=24))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Rotate90() %d bits per pixel not supported",pSource->Bits);
		k_EmptyString(&str);
		return;
	}
	...
	/* add comment to history */
	{
		TString History;
		k_InitString(&History);
		k_SprintfString(&History,"%sk_Rotate90(Steps=%d)",ipl_HistoryIndent,Steps);
	...
	else if (ActSteps==2)
	{
		if (pSource->Bits==1)
		{
			for(y=0; y<(int)pSource->Height; y++)
				for(x=0; x<(int)pSource->Width; x++)
					k_SetPixel1bp(x,MaxYIndex-y,k_GetPixel1bp(x,y,*pSource),NewImage);
		}
		else if (pSource->Bits==8)
		{
			for(y=0; y<(int)pSource->Height; y++)
				for(x=0; x<(int)pSource->Width; x++)
					k_SetPixel8bp(x,MaxYIndex-y,k_GetPixel8bp(x,y,*pSource),NewImage);
		}
		else /* must be 24 b/p */
		{
			for(y=0; y<(int)pSource->Height; y++)
				for(x=0; x<(int)pSource->Width; x++)
					k_SetPixel24bp(x,MaxYIndex-y,k_GetPixel24bp(x,y,*pSource),NewImage);
		}
	}
	else if (ActSteps==3)
	{
...
void k_FlipHorisontal(TImage* pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_FlipHorisontal() Image is empty - doing nothing");
		k_EmptyString(&str);
		return;
	}
	if ((pSource->Bits!=1) && (pSource->Bits!=8) && (pSource->Bits!=24))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_FlipHorisontal() %d bits per pixel not supported",pSource->Bits);
		k_EmptyString(&str);
		return;
	}
	...
	/* add comment to history */
	{
		TString History;
		k_InitString(&History);
		k_SprintfString(&History,"%sk_FlipHorisontal()",ipl_HistoryIndent);
		k_AppendTextIPL(&(pSource->History),History.pChars);
		k_EmptyString(&History);
		k_IplStartHistoryMacro();
	}
#endif
...
void k_FlipVertical(TImage* pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_FlipVertical() Image is empty - doing nothing");
		k_EmptyString(&str);
		return;
	}
	if ((pSource->Bits!=1) && (pSource->Bits!=8) && (pSource->Bits!=24))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_FlipVertical() %d bits per pixel not supported",pSource->Bits);
		k_EmptyString(&str);
		return;
	}
	...
	/* add comment to history */
	{
		TString History;
		k_InitString(&History);
		k_SprintfString(&History,"%sk_FlipVertical()",ipl_HistoryIndent);
		k_AppendTextIPL(&(NewImage.History),History.pChars);
		k_EmptyString(&History);
		k_IplStartHistoryMacro();
	}
...
{ 
	if ((pImg->Origin!=EMPTY) && (pImg->Bits==8))
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_ApplyBias() Bias=%g",ipl_HistoryIndent,Bias);
			k_AppendTextIPL(&(pImg->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
#endif
	...
	else
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_ApplyBias(): Source image is empty or has not 8 b/p");
		k_EmptyString(&str);
		return false;
	}
}
...
{ 
	if ((pImg->Origin!=EMPTY) && (pImg->Bits==8))
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_ScaleIntensity() Prefactor=%g",ipl_HistoryIndent,Prefactor);
			k_AppendTextIPL(&(pImg->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_ScaleIntensity: Source image is empty or has not 8 b/p");
		k_EmptyString(&str);
		return false;
	}
}
...
bool k_Add(TImage *pImg,TImage *pAddend)
{
		...
		|| (pImg->Bits!=8)||(pAddend->Bits!=8))
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Add(): Images are empty, have different size, or does not have 8 b/p");
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_Add() Adding a TImage",ipl_HistoryIndent);
			k_AppendTextIPL(&(pImg->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
...
bool k_Subtract(TImage *pImg,TImage *pSubtrahend)
{
		...
		|| (pImg->Bits!=8) || (pSubtrahend->Bits!=8))
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Subtract(): Images are empty, have different size, or does not have 8 b/p");
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_Subtract() subtracting a TImage",ipl_HistoryIndent);
			k_AppendTextIPL(&(pImg->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
...
bool k_Multiply(TImage *pImg,TImage *pFactor)
{
		...
		|| (pImg->Bits!=8) || (pFactor->Bits!=8))
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_Multiply(): Images are empty, have different size, or does not have 8 b/p");
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_Multiply() multiplying a TImage",ipl_HistoryIndent);
			k_AppendTextIPL(&(pImg->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
...
bool k_CopyDisplace(int dx,int dy,TImage *pImg)
{
	if (pImg->Origin!=EMPTY)
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyDisplace() dx=%d dy=%d",ipl_HistoryIndent,dx,dy);
			k_AppendTextIPL(&(Temp.History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
#endif
			...
			default:
				{
					...
					k_InitString(&str);
					k_AddFileAndLine(str);
					k_ShowMessage(IPL_ERROR,&str,"k_CopyDisplace(): Only possible for 1, 8 or 24 bit per pixel");
					k_EmptyString(&str);
					return false;
				}
		}
	...
	else
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopyDisplace(): Image is empty");
		k_EmptyString(&str);
		return false;
	}
}
...
bool k_CutOrZeroPad(TImage* pDest,TImage *pSource)
{
		...
		(ws>0) && (hs>0) && (wd>0) && (hd>0) && (pSource!=pDest))
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CutOrZeroPad() Source image file info: %s",
				ipl_HistoryIndent,pSource->FileInfo.PathAndFileName);
			k_AppendTextIPL(&(pDest->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
	...
	else
	{
		...
		if (pSource==pDest)
		{
			k_ShowMessage(IPL_ERROR,&str,"k_CutOrZeroPad(): Cannot use same image as dest/source"); 
		}
		else if ((ws<=0)||(hs<=0)||(wd<=0)||(hd<=0))
		{
			k_ShowMessage(IPL_ERROR,&str,"k_CutOrZeroPad(): One or both images have no pixels");
		}
		else
		{
			k_ShowMessage(IPL_ERROR,&str,"k_CutOrZeroPad(): One or both images are empty");
		}
		k_EmptyString(&str);
		return false;
	}
...
bool k_CopyFromInt(TImage *pDest,TIntImage *pSource)
{
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopyFromInt(): Image is empty");
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyFromInt()",ipl_HistoryIndent);
			k_AppendTextIPL(&(pDest->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
...
bool k_CopyFromFloat(TImage *pDest,TFloatImage *pSource)
{
	...
	if (pSource->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopyFromFloat(): Image is empty");
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyFromFloat()",ipl_HistoryIndent);
			k_AppendTextIPL(&(pDest->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
...
bool k_CopyFromComplex(COMPLEXCHOISE mode, TImage *pDest,TComplexImage *pSource)
{
	if (pSource->Origin==EMPTY)
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_CopyFromComplex(): Image is empty");
		k_EmptyString(&str);
		return false;
	}
	else
	{
		...
		/* add comment to history */
		{
			TString History;
			k_InitString(&History);
			k_SprintfString(&History,"%sk_CopyFromComplex()",ipl_HistoryIndent);
			k_AppendTextIPL(&(pDest->History),History.pChars);
			k_EmptyString(&History);
			k_IplStartHistoryMacro();
		}
...
void k_PrintImageInfo(const TImage* pInfo)
{
	...
	printf("**************** Image info ********************\n");
	printf(" Width=%d Height=%d ByteWidth=%d SizeImage=%d Bits=%d\n",
...
bool k_DrawLine(T2DInt Start, T2DInt End, UINT32 Color, TImage *pDest)
{
	...
	if (pDest==NULL)
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_DrawLine(): Image is empty");
		k_EmptyString(&str);
		return false;
	}
	k_InitGroup(&grp);
...
bool k_DrawCircle(T2DInt Center, unsigned int Radius, UINT32 Color, TImage *pDest)
{
	...
	if (pDest==NULL)
	{
        ...
        k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_DrawCircle(): Image is empty");
		k_EmptyString(&str);
		return false;
	}
	k_InitGroup(&grp);
...
UINT32 k_GetPixel(int x, int y,const TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_GetPixel() Only implemented for 1,8 and 24 bit per pixels");
				k_EmptyString(&str);
				return 0;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetPixel(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return 0;
	}
}
...
bool k_SetPixel(int x, int y, UINT32 Color,TImage* pInfo)
{
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetPixel() Only implemented for 1,8 and 24 bit per pixels");
				k_EmptyString(&str);
				return false;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SetPixel(%d,%d) Outside image and border",x,y);
		k_EmptyString(&str);
		return false;
	}
}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_GetPixelFast() Only implemented for 1,8 and 24 bit per pixels");
			k_EmptyString(&str);
			return 0;
		}
	}
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_SetPixelFast() Only implemented for 1,8 and 24 bit per pixels");
			k_EmptyString(&str);
			return false;
		}
	}
...
float k_GetPixelInterpolated(float x, float y, const TImage* pInfo)
{
	...
	if ((pInfo->Bits!=1) && (pInfo->Bits!=4) && (pInfo->Bits!=8))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetPixelInterpolated() Image must be 1, 4 or 8 b/p");
		k_EmptyString(&str);
		return 0;
	}
		...
		case 4:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_GetPixelInterpolated() Image with 4 b/p not implemented yet");
				k_EmptyString(&str);
				return 0;
			}
		case 8:
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_GetPixelInterpolated() Pixel depth (b/p) must be 1 or 8 (current is %d b/p)\n",pInfo->Bits);
				k_EmptyString(&str);
				return -1;
			}
		}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetPixelInterpolated(%.2f,%.2f) Needs "
	...
	case 4:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_GetPixelInterpolatedFast() Image with 4 b/p not implemented yet");
			k_EmptyString(&str);
			return 0;
		}
	case 8:
	...
	default:
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_GetPixelInterpolatedFast() Pixel depth (b/p) must be 1 or 8 (current is %d b/p)\n",pInfo->Bits);
			k_EmptyString(&str);
			return -1;
		}
	}
...
UINT32 k_GetColorInterpolated(float x, float y, const TImage* pInfo)
{
	...
	if (pInfo->Bits!=24)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetColorInterpolated() Image must be 24 b/p");
		k_EmptyString(&str);
		return 0;
	}
	...
	else
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GetColorInterpolated(%.2f,%.2f) Needs "
			"to access pixels outside image and border\n",x,y);
		k_EmptyString(&str);
		return 0;
	}
		...
		default:
			{
				...
				k_InitString(&str);
				k_AddFileAndLine(str);
				k_ShowMessage(IPL_ERROR,&str,"k_SetImageMatrix() Only possible for 1, 8 or 24 bit per pixel");
				k_EmptyString(&str);
			}
	}
}
...
bool k_LoadBMP(FILE* fp,TImage* pInfo)
{
	...
	if(tFileHeader.bfType != 0x4d42) /* 'BM' */
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadBMP() Not a BMP file");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	if (tInfoHeader.biSize!=40)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadBMP() Not a windows BMP file");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	if (tInfoHeader.biCompression!=0)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadBMP() Cannot read compressed BMP files");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	if(fread(pInfo->pPixelStream,sizeof(UINT8),pInfo->TotalSize,fp) != pInfo->TotalSize)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadBMP() Failed reading image data");
	    k_EmptyString(&str);
		fclose(fp);
		return false;
	}
...
bool k_SaveBMP(FILE* fp,TImage* pInfo)
{
	if (pInfo->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SaveBMP() No image to save");
		k_EmptyString(&str);
		return false;
	}
	else
...
bool k_LoadPGM(FILE* fp,TImage* pInfo)
{
	...
	if(Type == 0x3250) /* 'P2' */
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadPGM() PGM in ascii format not supported");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	else if (Type != 0x3550) /* 'P5' */
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadPGM() Not a PGM file");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	if (k_SkipWhiteSpace(fp)<1)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadPGM() Invalid header (1)");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	fscanf(fp,"%i",&pInfo->Width); /* width of image */
	if (k_SkipWhiteSpace(fp)<1)
	{
		TString str;
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadPGM() Invalid header (2)");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	fscanf(fp,"%i",&pInfo->Height); /* height of image */
	...
	if (MaxVal!=255)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_LoadPGM() Number of gray tones must be 255 (actual is %d)",MaxVal);
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	for(y=0; y<pInfo->Height; y++)
	{
		if (fread(pImageTemp,sizeof(UINT8),pInfo->Width,fp) != pInfo->Width)
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_ERROR,&str,"k_LoadPGM() Failed reading image data");
			k_EmptyString(&str);
			fclose(fp);
			return false;
		}
...
bool k_SavePGM(FILE* fp,TImage* pInfo)
{
	if (pInfo->Origin==EMPTY)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_WARNING,&str,"k_SavePGM() No image to save");
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	...
	else if (pInfo->Bits != 8)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_SavePGM() Image must be 8 b/p (actual is %d b/p)",pInfo->Bits);
		k_EmptyString(&str);
		fclose(fp);
		return false;
	}
	else
	{
		...
		if (count!=(UINT32)pInfo->Pal.PalEntries)
		{
			...
			k_InitString(&str);
			k_AddFileAndLine(str);
			k_ShowMessage(IPL_WARNING,&str,"k_SavePGM()  Not a gray tone palette (saving anyway!)");
			k_EmptyString(&str);
		}
		...
		if (pHistory!=NULL)
		{
			fprintf(fp,"P5\n%s%i %i\n255\n",pHistory,pInfo->Width,pInfo->Height);
			free(pHistory);
		}
		else
		{
  ...
  if (buffer==NULL)
    {
      ...
      k_InitString(&str);
      k_AddFileAndLine(str);
      k_ShowMessage(IPL_ERROR,&str,"k_LoadPCD() malloc error");
      fclose(fp);
      return false;
    }
  ...
  if (fileSize < 49152)
    {
      ...
      k_InitString(&str);
      k_AddFileAndLine(str);
      k_ShowMessage(IPL_ERROR,&str,"k_LoadPCD() probably not a PhotoCD image (too small)");
      fclose(fp);
      free(buffer);
      return false;
    }
