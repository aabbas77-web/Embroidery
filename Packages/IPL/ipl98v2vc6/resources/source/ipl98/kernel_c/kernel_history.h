...
/** @defgroup history Variables and functions for working with the history
...
#define k_IplStartHistoryMacro() {ipl_HistoryIndent[strlen(ipl_HistoryIndent)+1]='\0';memset(ipl_HistoryIndent,'\t',strlen(ipl_HistoryIndent)+1);}
