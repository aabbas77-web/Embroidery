...
/** \defgroup c_only_globals IPL98 Global C only enums, definitions, structs etc.
    @{ */

/** \defgroup structs_2d_3d IPL98 2D and 3D structures (global)
