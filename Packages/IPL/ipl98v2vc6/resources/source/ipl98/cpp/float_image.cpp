...
CFloatImage& CFloatImage::operator=(const CFloatImage& SourceImage)
{
	...
	if (this != &SourceImage)
	{
		...
		if (SourceImage.GetOrigin()!=EMPTY)
		{
			...
			k_SprintfString(&History,"%sCFloatImage::operator=",ipl_HistoryIndent);
...
bool CFloatImage::Load(const char* pPathAndFileName)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Load(%s)",ipl_HistoryIndent,pPathAndFileName);
...
bool CFloatImage::Save(const char* pPathAndFileName)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Save(%s)",ipl_HistoryIndent,pPathAndFileName);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::Flush(FLOAT32 Color)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Flush(Color=%d)",ipl_HistoryIndent,Color);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
		  ...
		  int xmax,int ymax)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::CopySubImage(xmin=%d,ymin=%d,xmax=%d,ymax=%d) Source image file info: %s",
		ipl_HistoryIndent,xmin,ymin,xmax,ymax,SourceImage.GetConstTFloatImagePtr()->FileInfo.PathAndFileName);
		  ...
		  const CPoint2D<int>& LowerRight)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::CopySubImage(UpperLeft=(%d,%d),LowerLeft=(%d,%d)) Source image file info: %s",
		ipl_HistoryIndent,UpperLeft.GetX(),UpperLeft.GetY(),LowerRight.GetX(),LowerRight.GetY(),SourceImage.GetConstTFloatImagePtr()->FileInfo.PathAndFileName);
	SourceImage.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CFloatImage::Rotate90(int Steps)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Rotate90(Steps=%d)",ipl_HistoryIndent,Steps);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CFloatImage::FlipHorisontal()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::FlipHorisontal()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CFloatImage::FlipVertical()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::FlipVertical()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
ostream& operator<<(ostream& s,const CFloatImage& Img)
{
	s << "*************** IntImage info ******************\n" << 
		...
		(Img.GetConstTFloatImagePtr())->TotalSize << endl << " BorderSize=" <<
...
bool CFloatImage::ApplyBias(float Bias)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::ApplyBias() Bias=%g",ipl_HistoryIndent,Bias);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::ScaleIntensity(float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::ScaleIntensity() Prefactor=%g",ipl_HistoryIndent,Prefactor);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::Add(CFloatImage &Addend)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Add() adding a CFloatImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::Subtract(CFloatImage &Subtrahend)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Subtract() subtracting a CFloatImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::Multiply(CFloatImage &Factor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Multiply() multiplying a CFloatImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::CopyDisplace(int dx, int dy)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::CopyDisplace() dx=%d dy=%d",ipl_HistoryIndent,dx,dy);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::CutOrZeroPad(CFloatImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::CutOrZeroPad() Source image file info: %s",
...
bool CFloatImage::Copy(CStdImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Copy() source: CStdImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::Copy(CIntImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Copy() source: CIntImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CFloatImage::Copy(COMPLEXCHOISE mode, CComplexImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCFloatImage::Copy() source: CComplexImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
