...
/** Iterator class to access data from the class CPixelGroup, last updated 1/25/2002.
...
public:
	...
	inline CPixelGroupConstIterator& operator=(const CPixelGroupIterator& It);
	...
	@return true, if iterator p points to element earlier than q. */
	friend bool operator<(const CPixelGroupConstIterator& p, const CPixelGroupIterator& q){return p.m_pCurr<&(*q);}
};
...
inline CPixelGroupConstIterator& CPixelGroupConstIterator::operator=(const CPixelGroupIterator& It)
{
	m_pCurr=&(*It);
	return *this;
}
