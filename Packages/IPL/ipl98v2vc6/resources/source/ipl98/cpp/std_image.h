...
class CStdImage : public CGenericImage{
	...
	public: // methods
		...
		/** Returns a pixel value at position (x,y), without range check.
			...
			@param y The position in vertical direction.
			@return pixel value, for 24 b/p: R+G*256+B*256*256. */
		virtual inline UINT32 GetPixelFast(int x, int y) const=0;
		...
		/** returns the interpolated color value at position (x,y), without
			range check. To be used for images with 24 b/p only. Uses bilinar 
			interpolation for each color channel (R, G and B) and rounds of
			to nearest integer value.
			@param x The position in horisontal direction
			@param y The position in vertical direction
		...
		virtual inline bool SetPixel(int x, int y, UINT32 Color)=0; 
		...
		/** Sets a pixel at position Pos,
			...
			@param Color The new pixel value, for 24 b/p images an RGB value,
				otherwise a palette index value.
			@return false if outside image or if b/p is not supported. */
		virtual inline bool SetPixel(const CPoint2D<INT16>& Pos, UINT32 Color)=0; 
		/** Sets a pixel at position (x,y), without range check, fast access.
			@param x The position in horisontal direction.
			@param y The position in vertical direction.
			@param Color The new pixel value, for 24 b/p images an RGB value,
				otherwise a palette index value. */
		virtual inline void SetPixelFast(int x, int y, UINT32 Color)=0; 
		...
		virtual inline UINT8 GetRedComponent(int x, int y);
		/** Returns the red component value at position (x,y), without range check.
			...
			@param y The position in vertical direction.
			@return Red component value */
		virtual inline UINT8 GetRedComponentFast(int x, int y);
		/** Returns the red component value at position Pos, including range check.
			...
			@param Pos 2-Dimensional position in image.
			@return Red component value */
		virtual inline UINT8 GetRedComponent(const CPoint2D<int>& Pos);
		/** Returns the red component value at position Pos, without range check.
			...
			@param Pos 2-Dimensional position in image.
			@return Red component value */
		virtual inline UINT8 GetRedComponentFast(const CPoint2D<int>& Pos);
		...
		virtual inline UINT8 GetGreenComponent(int x, int y);
		/** Returns the green component value at position (x,y), without range check.
			...
			@param y The position in vertical direction.
			@return Green component value */
		virtual inline UINT8 GetGreenComponentFast(int x, int y);
		/** Returns the green component value at position Pos, including range check.
			...
			@param Pos 2-Dimensional position in image.
			@return Green component value */
		virtual inline UINT8 GetGreenComponent(const CPoint2D<int>& Pos);
		/** Returns the green component value at position Pos, without range check.
			...
			@param Pos 2-Dimensional position in image.
			@return Green component value */
		virtual inline UINT8 GetGreenComponentFast(const CPoint2D<int>& Pos);
		...
		virtual inline UINT8 GetBlueComponent(int x, int y);
		/** Returns the blue component value at position (x,y), without range check.
			...
			@param y The position in vertical direction.
			@return Blue component value */
		virtual inline UINT8 GetBlueComponentFast(int x, int y);
		/** Returns the blue component value at position Pos, including range check.
			...
			@param Pos 2-Dimensional position in image.
			@return Blue component value */
		virtual inline UINT8 GetBlueComponent(const CPoint2D<int>& Pos);
		/** Returns the blue component value at position Pos, without range check.
			...
			@param Pos 2-Dimensional position in image.
			@return Blue component value */
		virtual inline UINT8 GetBlueComponentFast(const CPoint2D<int>& Pos);
		...
		/** Copies a CStdImage to this image.
			...
			@param UpperLeft position in the upper left corner to start from.
			@param LowerRight position in the lower left corner to stop at.
			@return false if outside image */
...
inline UINT8 CStdImage::GetRedComponent(int x, int y)
{
	return k_GetRedComponent(x,y,&m_Image);
}

inline UINT8 CStdImage::GetRedComponentFast(int x, int y)
{
	return k_GetRedComponentFast(x,y,&m_Image);
}

inline UINT8 CStdImage::GetRedComponent(const CPoint2D<int>& Pos)
{
	return k_GetRedComponent(Pos.GetX(),Pos.GetY(),&m_Image);
}

inline UINT8 CStdImage::GetRedComponentFast(const CPoint2D<int>& Pos)
{
	return k_GetRedComponentFast(Pos.GetX(),Pos.GetY(),&m_Image);
}

inline UINT8 CStdImage::GetGreenComponent(int x, int y)
{
	return k_GetGreenComponent(x,y,&m_Image);
}

inline UINT8 CStdImage::GetGreenComponentFast(int x, int y)
{
	return k_GetGreenComponentFast(x,y,&m_Image);
}

inline UINT8 CStdImage::GetGreenComponent(const CPoint2D<int>& Pos)
{
	return k_GetGreenComponent(Pos.GetX(),Pos.GetY(),&m_Image);
}

inline UINT8 CStdImage::GetGreenComponentFast(const CPoint2D<int>& Pos)
{
	return k_GetGreenComponentFast(Pos.GetX(),Pos.GetY(),&m_Image);
}

inline UINT8 CStdImage::GetBlueComponent(int x, int y)
{
	return k_GetBlueComponent(x,y,&m_Image);
}

inline UINT8 CStdImage::GetBlueComponentFast(int x, int y)
{
	return k_GetBlueComponentFast(x,y,&m_Image);
}

inline UINT8 CStdImage::GetBlueComponent(const CPoint2D<int>& Pos)
{
	return k_GetBlueComponent(Pos.GetX(),Pos.GetY(),&m_Image);
}

inline UINT8 CStdImage::GetBlueComponentFast(const CPoint2D<int>& Pos)
{
