...
/** Probabilistic Randomized Hough Transform. 
	...
	\class CHoughProbRHTLine ipl98/cpp/algorithms/hough_probrht_line.h
...
public:
	...
	*/
	...
	/** Constructor of the clss.
		...
		@param WrtieOutputFiles If to make disk output. Set to false (no output) by default.
   ...
   */
   bool Initialize(float Ratio, CBinaryImage& Source, int Thickness=1,
...
private:
   ...
   */    
   void PerformSelection(float Ratio, CBinaryImage& Source);
