...
/** CMorphology Simple morphological methods, Last updated 8/24/1999.
...
class CMorphology{
	...
	public: // methods
		...
		@see Dilate */
		bool DilateFast(CStdImage& Img,unsigned short q10,unsigned short q20,unsigned short q30);
		...
		@author Implementation by Ivar Balslev (ivb@mip.sdu.dk)
		@see Erode */
		bool ErodeFast(CStdImage& Img,unsigned short q10,unsigned short q20,unsigned short q30);
		...
		@author Implementation by Ivar Balslev (ivb@mip.sdu.dk)
		@see ErodeFast */
		bool Erode(const CStdImage& ImgMask, CStdImage& Img);
		...
		@author Implementation by Ivar Balslev (ivb@mip.sdu.dk)
		@see DilateFast */
		bool Dilate(const CStdImage& ImgMask, CStdImage& Img);
		...
		@see Thinning
		@see SkeletonZhou */
		int Skeletonizing(CStdImage& Img);
		...
		@see Thinning
		@see Skeletonizing */
		int SkeletonZhou(CStdImage& Img, bool PreserveCorners);
};
