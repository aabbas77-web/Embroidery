...
/** CMaskOperation: Simple Mask operations, Last updated 8/21/2000. 
...
class CMaskOperation{
	...
	public: // methods
		...
		bool Convolve(CStdImage &Img,const CFloatImage &Mask);
		/** calculates the convolution of Source and Mask. Mask is always
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool Convolve(CStdImage &Source,const CFloatImage &Mask,CIntImage &Dest);
		/** calculates the convolution of Img and Mask. Mask is
			always a float image. No dimension of Mask should exceed that of Img.
			Boundary conditions periodic with width and height of Img are
			assumed. Reference cell is (0,0) of Mask. Apply CopyDisplace or
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool Convolve(CIntImage &Img,const CFloatImage &Mask);
		/** Convolve calculates the convolution of Img and Mask. Mask is
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool Convolve(CFloatImage &Img,const CFloatImage &Mask);
		/** Blurs the image. It is a speed optimized blur algorithm
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool BlurFourConnected3x3(CStdImage &Img);
		/** Blurs the image. It is a speed optimized blur algorithm
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool BlurEightConnected3x3(CStdImage &Img);
		/** Same functionality as BlurEightConnected3x3(CStdImage) but works on
			...
			@version 0.80
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool BlurEightConnected3x3(CIntImage &Img);
		/** ConvolveFast performs a convolutions of Img using a 3x3
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool ConvolveFast(CStdImage &Img,const CFloatImage& Mask,float Prefactor);
		/** ConvolveFast performs a convolutions of pSource using a 3x3
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool ConvolveFast(CStdImage &Source, const CFloatImage &Mask,
		...
		/** ConvolveFast performs a convolutions of Source of class CIntImage
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool ConvolveFast(CIntImage &Img, const CFloatImage &Mask,float Prefactor);
		/** MaxGradientFast is an edge detecting algoritm.
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MaxGradientFast(CStdImage &Img,float Prefactor);
		/** MaxGradientFast is an edge detecting algoritm.
			It calculates the maximum absolute graytone difference
			of two opposite neighbour pixels over the 4 possible directions.
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MaxGradientFast(CStdImage &Source,float Prefactor,CIntImage &Dest);
		/** MaxGradientFast is an edge detecting algoritm.
			It calculates the maximum absolute graytone difference
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MaxGradientFast(CIntImage &Img,float Prefactor);
		/** MedianFilterFourConnected3x3 takes the median of the graytone among the 5
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MedianFilterFourConnected3x3(CStdImage &Img);
		/** takes the median of the graytone among the 5 pixels.
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MedianFilterDiagonalConnected3x3(CStdImage &Img);
		/** takes the median of the graytone among the 5 pixels.
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MedianFilterFourConnected3x3(CIntImage &Img);
		/** takes the median of the graytone among the 5
			...
			@version 0.85
			@author Implemented by Ivar Balslev (ivb@mip.sdu.dk) */
		bool MedianFilterDiagonalConnected3x3(CIntImage &Img);
};
