...
class CCoordinateTransform{
	...
	bool ScaleAndRotateAuto(CStdImage& Source,CStdImage& Dest,double Sx, double Sy, double phi,UINT32 Background);
	...
	/** Makes an image with dimensions (Width * Height) and unchanged bits per pixel.
		...
		@version 1.00
		@author Implementation by Ivar Balslev (ivb@mip.sdu.dk) */
	bool ScaleAndRotateFixed(CStdImage& Source,CStdImage& Dest,double x0,double y0,
	...
	/** Performs a scaling using the scale factors (Sx,Sy) and autosizing of the new
		...
		@version 1.00
		@author Implementation by Ivar Balslev (ivb@mip.sdu.dk) */
	bool ScaleAuto(CStdImage& Source,CStdImage& Dest,double Sx, double Sy, UINT32 Background);
	...
	/** Makes an image with dimensions (Width * Height).and unchanged bits per pixel.
		...
		@version 1.00
		@author Implementation by Ivar Balslev (ivb@mip.sdu.dk) */
	bool ScaleFixed(CStdImage& Source,CStdImage& Dest,double x0,double y0,
