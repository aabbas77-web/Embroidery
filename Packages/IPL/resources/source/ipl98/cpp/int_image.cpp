...
bool CIntImage::Load(const char* pPathAndFileName)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Load(%s)",ipl_HistoryIndent,pPathAndFileName);
...
bool CIntImage::Save(const char* pPathAndFileName)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Save(%s)",ipl_HistoryIndent,pPathAndFileName);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::Flush(INT16 Color)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Flush(Color=%d)",ipl_HistoryIndent,Color);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
		  ...
		  int xmax,int ymax)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::CopySubImage(xmin=%d,ymin=%d,xmax=%d,ymax=%d) Source image file info: %s",
		ipl_HistoryIndent,xmin,ymin,xmax,ymax,SourceImage.GetConstTIntImagePtr()->FileInfo.PathAndFileName);
		  ...
		  const CPoint2D<int>& LowerRight)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::CopySubImage(UpperLeft=(%d,%d),LowerLeft=(%d,%d)) Source image file info: %s",
		ipl_HistoryIndent,UpperLeft.GetX(),UpperLeft.GetY(),LowerRight.GetX(),LowerRight.GetY(),SourceImage.GetConstTIntImagePtr()->FileInfo.PathAndFileName);
	SourceImage.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CIntImage::Rotate90(int Steps)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Rotate90(Steps=%d)",ipl_HistoryIndent,Steps);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CIntImage::FlipHorisontal()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::FlipHorisontal()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CIntImage::FlipVertical()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::FlipVertical()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
ostream& operator<<(ostream& s,const CIntImage& Img)
{
	s << "*************** IntImage info ******************\n" << 
		...
		(Img.GetConstTIntImagePtr())->TotalSize << endl << " BorderSize=" <<
...
bool CIntImage::ApplyBias(int Bias)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::ApplyBias() Bias=%d",ipl_HistoryIndent,Bias);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::ScaleIntensity(float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::ScaleIntensity() Prefactor=%g",ipl_HistoryIndent,Prefactor);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::Add(CIntImage &Addend)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Add() adding a CIntImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::Subtract(CIntImage &Subtrahend)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Subtract() subtracting a CIntImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::Multiply(CIntImage &Factor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Multiply() multiplying a CIntImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::CopyDisplace(int dx, int dy)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::CopyDisplace() dx=%d dy=%d",ipl_HistoryIndent,dx,dy);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::CutOrZeroPad(CIntImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::CutOrZeroPad() Source image file info: %s",
...
bool CIntImage::Copy(CStdImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Copy() source: CStdImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::Copy(CFloatImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Copy() source: CFloatImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CIntImage::Copy(COMPLEXCHOISE mode, CComplexImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCIntImage::Copy() source: CComplexImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
