											  ...
											  double Sx, double Sy, double phi,UINT32 Background)
{
	...
	k_SprintfString(&History,"%sCCoordinateTransform::ScaleAndRotateAuto(Sx=%g,Sy=%g,phi=%g,Background=%d)",
						   ...
						   int Width,int Height,double Sx, double Sy, double phi,UINT32 Background)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCCoordinateTransform::ScaleAndRotateFixed(x0=%g,y0=%g,Width=%d,Height=%d,Sx=%g,Sy=%g,phi=%g,Background=%d)",
									 ...
									 double Sx, double Sy, UINT32 Background)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCCoordinateTransform::ScaleAuto(Sx=%g,Sy=%g,Background=%d)",
				  ...
				  int Width,int Height,double Sx, double Sy,UINT32 Background)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCCoordinateTransform::ScaleFixed(x0=%g,y0=%g,Width=%d,Height=%d,Sx=%g,Sy=%g,Background=%d)",
