...
bool CMorphology::DilateFast(CStdImage& Img,unsigned short q10,unsigned short q20,unsigned short q30)
{
	...
	k_SprintfString(&History,"%sCMorphology::DilateFast(q10=%d,q20=%d,q30=%d)",ipl_HistoryIndent,q10,q20,q30);
...
bool CMorphology::ErodeFast(CStdImage& Img,unsigned short q10,unsigned short q20,unsigned short q30)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMorphology::ErodeFast(q10=%d,q20=%d,q30=%d)",ipl_HistoryIndent,q10,q20,q30);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CMorphology::Erode(const CStdImage& ImgMask, CStdImage& Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMorphology::Erode() with dimensions (%d*%d)",
...
bool CMorphology::Dilate(const CStdImage& ImgMask, CStdImage& Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMorphology::Dilate() with dimensions (%d*%d)",
		ipl_HistoryIndent,ImgMask.GetWidth(),ImgMask.GetHeight());
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
int CMorphology::Thinning(CStdImage& Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMorphology::Thinning())",ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
int CMorphology::Skeletonizing(CStdImage& Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMorphology::Skeletonizing())",ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
int CMorphology::SkeletonZhou(CStdImage& Img, bool PreserveCorners)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMorphology::SkeletonZhou())",ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
