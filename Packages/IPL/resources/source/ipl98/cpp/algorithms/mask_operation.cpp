...
bool CMaskOperation::Convolve(CStdImage &Img,const CFloatImage &Mask)
{
	...
	k_SprintfString(&History,"%sCMaskOperation::Convolve() source/dest: CStdImage, with a %d*%d mask",
		ipl_HistoryIndent,Mask.GetWidth(),Mask.GetHeight());
	Img.m_History.AppendIPL(History.pChars);
...
bool CMaskOperation::Convolve(CStdImage &Source,const CFloatImage &Mask,CIntImage &Dest)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::Convolve() source: CStdImage, dest:CIntImage, with a %d*%d mask",
		ipl_HistoryIndent,Mask.GetWidth(),Mask.GetHeight());
...
bool CMaskOperation::Convolve(CIntImage &Img,const CFloatImage &Mask)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::Convolve() source/dest: CIntImage, with a %d*%d mask",
		ipl_HistoryIndent,Mask.GetWidth(),Mask.GetHeight());
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::Convolve(CFloatImage &Img,const CFloatImage &Mask)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::Convolve() source/dest: CFloatImage, with a %d*%d mask",
		ipl_HistoryIndent,Mask.GetWidth(),Mask.GetHeight());
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::BlurFourConnected3x3(CStdImage &Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::BlurFourConnected3x3()",ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CMaskOperation::BlurEightConnected3x3(CStdImage &Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::BlurEightConnected3x3()",ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CMaskOperation::ConvolveFast(CStdImage &Img,const CFloatImage &Mask,float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::ConvolveFast() source/dest: CStdImage, prefactor=%g",
...
{ 
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::ConvolveFast() source: CStdImage, dest:CIntImage, prefactor=%g",
		ipl_HistoryIndent,Prefactor);
	Source.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
	...
	float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::ConvolveFast() source/dest: CIntImage, prefactor=%g",
		ipl_HistoryIndent,Prefactor);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MaxGradientFast(CStdImage &Img,float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MaxGradientFast() source/dest: CStdImage prefactor=%g",
		ipl_HistoryIndent,Prefactor);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MaxGradientFast(CStdImage &Source,float Prefactor,CIntImage &Dest)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MaxGradientFast() source: CStdImage, dest:CIntImage",
		ipl_HistoryIndent);
	Source.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MaxGradientFast(CIntImage &Img,float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MaxGradientFast() source/dest: CIntImage prefactor=%g",
		ipl_HistoryIndent,Prefactor);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MedianFilterFourConnected3x3(CStdImage &Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MedianFilterFourConnected3x3() source/dest: CStdImage",
		ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MedianFilterDiagonalConnected3x3(CStdImage &Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MedianFilterDiagonalConnected3x3() source/dest: CStdImage",
		ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MedianFilterFourConnected3x3(CIntImage &Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MedianFilterFourConnected3x3() source/dest: CIntImage",
		ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
...
bool CMaskOperation::MedianFilterDiagonalConnected3x3(CIntImage &Img)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCMaskOperation::MedianFilterDiagonalConnected3x3() source/dest: CIntImage",
		ipl_HistoryIndent);
	Img.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
