...
/** CHoughRHTLine class.
	...
	\class CHoughRHTLine ipl98/cpp/algorithms/hough_rht_line.h
...
public:
    ...
    */
   CHoughRHTLine::CHoughRHTLine(ostream& os, bool WriteOutputFiles, const string& FilePrefix="rht_");

   /** Destructor for the class.
   */
	virtual ~CHoughRHTLine();
   ...
   */
   bool Initialize(CBinaryImage& BinarySource, int Thickness=1,
...
private:
   ...
   */
   void WriteFiles(CBinaryImage& BImage, const CParameter2D<float>& Coordinate, int NumOfShapes);
