...
#ifndef _IPL98_BINARYIMAGE_H
#define _IPL98_BINARYIMAGE_H
...
// #include "hough_sdtstandard_hough.h"
...
public:
   ...
   */
   CBinaryImage(int w, int h, CHoughBase::ORIGINTYPE OriginType=CHoughBase::CENTER_UP);
   ...
   /** Constructor for CBinaryImage.
       ...
       @param OrigoType Type of the origin of the image. Center with y-axis upwards by default.
   */
   ...
   */
   ...
   /** By iteratively calling RemovePixel to remove a group of pixels. 
       ...
       @param range Radius of the group in pixels.
   */
   ...
   */
   CHoughBase::ORIGINTYPE GetOrigin() const;
...
private:
   ...
   CHoughBase::ORIGINTYPE m_origin;
   ...
   */
   void SetOrigin(CHoughBase::ORIGINTYPE OriginType=CHoughBase::CENTER_UP);
};

} // end namespace ipl

#endif _IPL98_BINARYIMAGE_H
