...
/** Iterator class to access data from the class CArray2D, last updated 10/10/2001.
...
public:
	/// Constructor
	CArray2DIterator(valarray<T>* vv, slice ss) :m_pData(vv), m_s(ss), m_Curr(0) { }
	...
	friend bool operator==(const CArray2DIterator& p, const CArray2DIterator& q);
	/** overloading != operator.
