...
CComplexImage& CComplexImage::operator=(const CComplexImage& SourceImage)
{
	...
	if (this != &SourceImage)
	{
		...
		if (SourceImage.GetOrigin()!=EMPTY)
		{
			...
			k_SprintfString(&History,"%sCIntImage::operator=",ipl_HistoryIndent);
...
bool CComplexImage::Load(const char* pPathAndFileName)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Load(%s)",ipl_HistoryIndent,pPathAndFileName);
...
bool CComplexImage::Save(const char* pPathAndFileName)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Save(%s)",ipl_HistoryIndent,pPathAndFileName);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::Flush(FLOAT32 Re, FLOAT32 Im)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Flush() Re=%g Im=%g",ipl_HistoryIndent,Re,Im);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
		  ...
		  int xmax,int ymax)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::CopySubImage(xmin=%d,ymin=%d,xmax=%d,ymax=%d) Source image file info: %s",
		ipl_HistoryIndent,xmin,ymin,xmax,ymax,SourceImage.GetConstTComplexImagePtr()->FileInfo.PathAndFileName);
		  ...
		  const CPoint2D<int>& LowerRight)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::CopySubImage(UpperLeft=(%d,%d),LowerLeft=(%d,%d)) Source image file info: %s",
		ipl_HistoryIndent,UpperLeft.GetX(),UpperLeft.GetY(),LowerRight.GetX(),LowerRight.GetY(),SourceImage.GetConstTComplexImagePtr()->FileInfo.PathAndFileName);
	SourceImage.m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CComplexImage::Rotate90(int Steps)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Rotate90(Steps=%d)",ipl_HistoryIndent,Steps);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CComplexImage::FlipHorisontal()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::FlipHorisontal()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
void CComplexImage::FlipVertical()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::FlipVertical()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
ostream& operator<<(ostream& s,const CComplexImage& Img)
{
	s << "************* ComplexImage info ****************\n" <<
		...
		(Img.GetConstTComplexImagePtr())->TotalSize << endl << " BorderSize=" <<
...
{ 
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::ApplyBias() Bias=%g",ipl_HistoryIndent,Bias);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::ScaleIntensity(float Prefactor)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::ScaleIntensity() Prefactor=%g",ipl_HistoryIndent,Prefactor);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::Add(CComplexImage &Addend)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Add() adding a CComplexImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
{ 
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Subtract() subtracting a CComplexImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
{ 
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Multiply() multiplying a CComplexImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
{ 
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::CCFactorAndMultiply()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::ComplexConjugate()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::ComplexConjugate()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::Rearrange()
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Rearrange()",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::CopyDisplace(int dx, int dy)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::CopyDisplace() dx=%d dy=%d",ipl_HistoryIndent,dx,dy);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::CutOrZeroPad(CComplexImage &Source)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::CutOrZeroPad() Source image file info: %s",
...
bool CComplexImage::Copy(CStdImage &Re, CStdImage &Im)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Copy() sources: CStdImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::Copy(CIntImage &Re, CIntImage &Im)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Copy() sources: CIntImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
...
bool CComplexImage::Copy(CFloatImage &Re, CFloatImage &Im)
{
	...
	TString History;
	k_InitString(&History);
	k_SprintfString(&History,"%sCComplexImage::Copy() sources: CFloatImage",ipl_HistoryIndent);
	m_History.AppendIPL(History.pChars);
	k_EmptyString(&History);
	k_IplStartHistoryMacro();
#endif
