...
/** CGenericImage is an abstract base class from which all
	image classes are derived, last updated 5/30/2001.
...
class CGenericImage
{
	...
	public: // methods
		...
		virtual inline int GetMinX() const=0;
		/** Iterate from this value.
			@return min. Y relative to origo */
		virtual inline int GetMinY() const=0;
		...
		/** Rotate image clockwise in step of 90 degrees.
			@Steps Rotate image 90 degrees * Steps */
