...
/** CPixelGroups contains several CPixelGroup classes, last updated 2/7/2001.
	...
	@see CPixelGroup
	@version 1.33,  by edr@mip.sdu.dk
...
class CPixelGroups {
	...
	public: // methods
		...
		/** overloading of []-operator. Returns a pointer to the group at Index, no range
			check, fast access. 
			@see GetGroup */
		CPixelGroup& operator[](unsigned int Index);
		/// Default destructor
		~CPixelGroups();
