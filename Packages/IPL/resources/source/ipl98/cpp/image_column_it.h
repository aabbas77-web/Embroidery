...
public:
	...
	inline CImageColumnIterator End() const;
	/** overloading ++ operator. Increments the pointer to data. */
	inline CImageColumnIterator& operator++(){ m_pCurr-=m_RowWidth; return *this; }
	/** overloading ++ operator. Increments the pointer to data. */
	inline CImageColumnIterator operator++(int){CImageColumnIterator t=*this;m_pCurr-=m_RowWidth;return t;}
	...
	inline friend bool operator==(const CImageColumnIterator& p, const CImageColumnIterator& q);
	/** overloading != operator.
