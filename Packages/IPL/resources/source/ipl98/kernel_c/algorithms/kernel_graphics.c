...
bool k_GraphicsGenerateLine(T2DInt Start, T2DInt End, TPixelGroup* pPixelGroup)
{
	...
	if (pPixelGroup==NULL)
	{
		...
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateLine() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
...
bool k_GraphicsGenerateLineThick(T2DInt Start, T2DInt End, unsigned int Width, TPixelGroup* pPixelGroup)
{
	...
	if (pPixelGroup==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateLineThick() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
	if (Width==0)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateLineThick() Width is 0");
	    k_EmptyString(&str);
		return false;
	}
	Angle=fabs(atan2(End.y-Start.y,End.x-Start.x));
...
bool k_GraphicsGenerateCircle(T2DInt Center, unsigned int Radius, TPixelGroup* pPixelGroup)
{
	...
	if (pPixelGroup==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateCircle() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
	while (x <= y)
...
bool k_GraphicsGenerateCircleRing(T2DInt Center, unsigned int Radius1, unsigned int Radius2, TPixelGroup* pPixelGroup)
{
	...
	if (pPixelGroup==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateCircleRing() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
	if (Radius1>Radius2)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateCircleRing() Radius1>Radius2");
	    k_EmptyString(&str);
		return false;
	}
	while (x1 <= y1)
...
bool k_GraphicsGenerateCircleRingW(T2DInt Center, unsigned int Radius, unsigned int Width, TPixelGroup* pPixelGroup)
{
	...
	if (Width==0)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateCircleRingW() Width is 0");
	    k_EmptyString(&str);
		return false;
	}
...
bool k_GraphicsGenerateEllipse(T2DInt Center, unsigned int RadiusX, unsigned int RadiusY, TPixelGroup* pPixelGroup)
{
	if ((RadiusX==0) || (RadiusY==0))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateEllipse() One of the main axises (RadiusX or RadiusY) is 0");
	    k_EmptyString(&str);
		return false;
	}
	else if (pPixelGroup==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateEllipse() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
	else
...
bool k_GraphicsGenerateCross(T2DInt Center, unsigned int Size, TPixelGroup* pPixelGroup)
{
	...
	if (pPixelGroup==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateCross() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
...
bool k_GraphicsGenerateRectangle(T2DInt TopLeft, T2DInt BottumRight, TPixelGroup* pPixelGroup)
{
	...
	if (pPixelGroup==NULL)
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateRectangle() PixelGroup is NULL");
	    k_EmptyString(&str);
		return false;
	}
	else if ((TopLeft.x>=BottumRight.x) || (TopLeft.y>=BottumRight.y))
	{
		...
		k_InitString(&str);
		k_AddFileAndLine(str);
		k_ShowMessage(IPL_ERROR,&str,"k_GraphicsGenerateRectangle() TopLeft and BottumRight not correct positioned");
	    k_EmptyString(&str);
		return false;
	}
