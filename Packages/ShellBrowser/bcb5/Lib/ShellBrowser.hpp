...
// (DO NOT EDIT: machine generated header) 'ShellBrowser.pas' rev: 5.00
...
__interface INTERFACE_UUID("{7D688A70-C613-11D0-999B-00C04FD655E1}") IShellIconOverlay  : public IUnknown 
...
protected:
	...
	AnsiString __fastcall GetDomain();
...
public:
	...
	AnsiString __fastcall GetDesktopName();
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EShellBrowserError(int Ident)/* overload */ : Sysutils::Exception(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EShellBrowserError(int Ident, int AHelpContext)/* overload */
		 : Sysutils::Exception(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EShellBrowserError(System::PResStringRec ResStringRec
...
extern PACKAGE AnsiString __fastcall GetMyDocumentsPath();
