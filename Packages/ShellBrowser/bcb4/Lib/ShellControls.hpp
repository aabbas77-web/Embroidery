...
// (DO NOT EDIT: machine generated header) 'ShellControls.pas' rev: 4.00
...
protected:
	...
	Shellbrowser::TOnContextMenuSelectEvent __fastcall GetOnContextMenuSelect(void);
...
protected:
	...
	AnsiString __fastcall GetSelectedFolder(void);
